    ...
    override fun buildPage(): Single<String> = Single
            ...
            .map { (_, queryUrl, _) ->
                parse(incognitoPageReader.provideHtml()
                        ...
                        .replace("\${nn_incognito_mode}", application.getString(R.string.nn_incognito_mode))
                        .replace("\${nn_incognito_mode_info}", application.getString(R.string.nn_incognito_mode_info))
                ) andBuild {
                    charset { UTF8 }
                    body {
                        tag("script") {
