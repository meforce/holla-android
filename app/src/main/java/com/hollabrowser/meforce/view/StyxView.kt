...
import com.hollabrowser.meforce.browser.TabModel
import com.hollabrowser.meforce.constant.*
import com.hollabrowser.meforce.controller.UIController
import com.hollabrowser.meforce.database.DomainSettings
...
import com.hollabrowser.meforce.extensions.addAction
import com.hollabrowser.meforce.extensions.canScrollVertically
import com.hollabrowser.meforce.extensions.makeSnackbar
import com.hollabrowser.meforce.isSupported
import com.hollabrowser.meforce.log.Logger
import com.hollabrowser.meforce.network.NetworkConnectivityModel
...
class StyxView(
    ...
    /**
     * Initialize the settings of the WebView that are intrinsic to Holla and cannot be altered
    ...
    fun loadUrl(aUrl: String) {
        ...
        if (iTargetUrl.scheme == Schemes.Holla || iTargetUrl.scheme == Schemes.About) {
