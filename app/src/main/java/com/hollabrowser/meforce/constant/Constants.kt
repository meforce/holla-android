...
package com.hollabrowser.meforce.constant
...
object Uris {
    const val StyxHome = "${Schemes.Holla}://${Hosts.Home}"
    const val StyxStart = "${Schemes.Holla}://${Hosts.Start}"
    const val StyxIncognito = "${Schemes.Holla}://${Hosts.Incognito}"
    const val StyxBookmarks = "${Schemes.Holla}://${Hosts.Bookmarks}"
    const val StyxDownloads = "${Schemes.Holla}://${Hosts.Downloads}"
    const val StyxHistory = "${Schemes.Holla}://${Hosts.History}"
    const val StyxNoop = "${Schemes.Holla}://${Hosts.Noop}"
