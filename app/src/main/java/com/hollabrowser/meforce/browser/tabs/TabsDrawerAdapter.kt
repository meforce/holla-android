...
import com.hollabrowser.meforce.extensions.setImageForTheme
...
class TabsDrawerAdapter(
    ...
    private fun updateViewHolderBackground(viewHolder: TabViewHolder, isForeground: Boolean) {
        viewHolder.iCardView.apply {
            ...
            params.height = context.dimen(if (isForeground) R.dimen.material_grid_touch_large else R.dimen.material_grid_touch_medium)
            layoutParams = params
        }
